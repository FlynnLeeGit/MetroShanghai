...
import StationWrapper from './StationWrapper.jsx';
...
const createClassHome=function(stationsData){  //此处需要返回class类的this 所以使用functin而不是arrow
  class Home extends React.Component {
    constructor(props) {
      super(props);
      this.state = {
        stationsData: stationsData, //所有站点信息的数据集合
        timeData: [],
